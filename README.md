...
| 12 | Prime Number | https://www.geeksforgeeks.org/problems/prime-number2314/1 | Handle n<=1 as not prime; check divisibility from 2..sqrt(n) (or i*i<=n) and return prime if none.